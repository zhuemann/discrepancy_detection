...
def train_discrepancy_detection(config):
    ...
    if need_setup:
        ...
        save_path = os.path.join(dir_base, 'Zach_Analysis/discrepancy_data/used_to_train_third_model/AI_Discrep_test_set_updated Apr 2023_new scoring.xlsx')
    ...
    #model_path = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/third_labeling_batch/radbert_final_model_first_train_v80/seed" + str(config["seed"])
