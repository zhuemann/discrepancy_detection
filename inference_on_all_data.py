...
def inference_on_all_data(config):
    ...
    save_string = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/initial_testing/second_dataset_bce_unbalanced_dups_removedv18_best_94.5/seed" + str(config["seed"])
