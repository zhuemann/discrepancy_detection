...
def inference_on_all_data(config):
    ...
    save_string = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/initial_testing/second_dataset_bce_loss_single_model_unbalanced_no_text_augv13/seed" + str(config["seed"])
