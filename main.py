...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 16, "dir_base": directory_base, "epochs": 20, "n_classes": 2, "LR": 5e-5,
                  "train_samples": .8, "test_samples": .5, "data_path": "D:/candid_ptx/"} #was .8 .5
    ...
    for seed in seeds:
        ...
        save_string = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/second_dataset_bce_loss_less_train_datav6/" + folder_name
