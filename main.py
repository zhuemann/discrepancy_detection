...
if __name__ == '__main__':
    ...
    for seed in seeds:
        ...
        save_string = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/third_labeling_batch/radbert_trained_on_first_second_set_pretrain_v86/" + folder_name
        save_location = os.path.join(directory_base, save_string)
