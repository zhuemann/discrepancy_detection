...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 16, "dir_base": directory_base, "epochs": 20, "n_classes": 2, "LR": 9e-6,
    ...
    for seed in seeds:
        ...
        save_string = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/roberta_large_unbalanced_dups_removed_matrixv23/" + folder_name
