...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 8, "dir_base": directory_base, "epochs": 250, "n_classes": 2, "LR": 5e-5,
    ...
    for seed in seeds:
        ...
        save_string = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/initial_testingv4/" + folder_name
