...
if __name__ == '__main__':
    ...
    for seed in seeds:
        ...
        save_string = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/third_labeling_batch/radbert_trained_on_firstand second_set_finetune_try2_v88/" + folder_name
        save_location = os.path.join(directory_base, save_string)
