...
if __name__ == '__main__':
    ...
    config = {"seed": 1, "batch_size": 16, "dir_base": directory_base, "epochs": 10, "n_classes": 2, "LR": 5e-6,
    ...
    for seed in seeds:
        ...
        save_string = "/UserData/Zach_Analysis/result_logs/discrepancy_detection/third_labeling_batch/radbert_fine_turning_original_v77/" + folder_name
